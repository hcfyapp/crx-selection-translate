...
(function ( global , factory ) {
    ...
    "use strict";
    var ep = Element.prototype, L;

    if ( 'function' !== typeof ep.matches ) { // 统一 matches 方法
        ep.matches = ep.webkitMatchesSelector || ep.mozMatchesSelector || ep.msMatchesSelector || ep.oMatchesSelector;
    }
    ...
    L.pubsub = (function () {
        ...
        var defineCallbacks = function ( o ) {
                var newCallbacks = {};
                Object.defineProperty( o , '_callbacks' , {value : newCallbacks , writable : false , enumerable : false} );
                return newCallbacks;
            },
